...
public class From_TTSS24UTRA extends javax.swing.JFrame {

    public From_TTSS24UTRA() {
        initComponents();
    ...
    private String[] imagePaths = {"/imageIP/s24u.jpg", "/imageIP/s24u1.jpg", "/imageIP/s24u2.jpg", "/imageIP/s24u3.jpg", "/imageIP/s24u4.jpg", "/imageIP/s24u5.jpg", "/imageIP/s24u6.jpg", "/imageIP/s24u7.jpg", "/imageIP/s24u8.jpg", "/imageIP/s24u9.jpg"};
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Galaxy S24 Ultra 5G Configuration");

        jLabel4.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel4.setText("Screen:                                          Dynamic AMOLED 2X, 6.8\"Quad HD+ (2K+)");

        jLabel5.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel5.setText("Operating system:                        Android 14");

        jLabel6.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel6.setText("Front camera:                               12 MP");

        jLabel7.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel7.setText("Chip:                                             Snapdragon 8 Gen 3 for Galaxy");

        jLabel8.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel8.setText("Rear camera:                                Main 200 MP & Secondary 50 MP, 12 MP");
        ...
        jLabel11.setText("Batteries and Chargers:                5000 mAh, 45 W");

        jLabel12.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel12.setText("Capacity:");

        jLabel13.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel13.setText("SIM:                                             2 Nano SIM & 1 eSIM Support 5G");
